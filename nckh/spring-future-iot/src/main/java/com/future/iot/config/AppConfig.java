...
public class AppConfig implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/admin/ckfinder/**").addResourceLocations("classpath:/static/ckfinder/");
    }
    ...
    public MqttClient mqttClient() throws MqttException {
        ...
        mqttClient.subscribe(env.getProperty("mqtt.topic.sensor.temperature"), qos, (topic, msg) -> {
            LOG.info(msg);
            sensorTemperatureApi.handlerEnCryptoData(msg.toString());
        });
    ...
    public ServletRegistrationBean connectCKFinder(){
        String url = "/admin/ckfinder/core/connector/java/connector.java";
        ServletRegistrationBean registrationBean = new ServletRegistrationBean(new ConnectorServlet(), url);
        registrationBean.addInitParameter("XMLConfig","/static/ckfinder.xml");
        registrationBean.addInitParameter("debug","false");
        registrationBean.addInitParameter("configuration","com.future.iot.config.CKFinderConfig");
